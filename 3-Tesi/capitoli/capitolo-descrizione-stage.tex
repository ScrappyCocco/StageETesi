...
\subsection{VTK}
VTK è un software open-source multipiattaforma per la computer grafica 3D, di cui parleremo nel capitolo 3.
...
\'E stato scelto anche per mostrare all'azienda come poter compilare e gestire un progetto C\texttt{++} con Qt, sostituendo il sistema di generazione di default utilizzato da Qt chiamato qmake.
