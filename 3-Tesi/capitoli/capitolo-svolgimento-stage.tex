...
Come si può notare è presente anche la Minimum Intensity, che raramente è utilizzata, ma è stata inserita comunque sotto consiglio del tutor. Com'è intuibile dal nome, funziona come la MIP ma utilizzando i valori minimi incontrati lungo il raggio. Nel caso fosse necessario, è immediato aggiungere anche la AVERAGE\_INTENSITY\_BLEND.
\\
...
\\
Tuttavia alcune librerie mi hanno dato grossi problemi, in quanto non riuscivo a compilarle e non riuscivo a comprenderne il motivo. Ne ho discusso con colleghi di lavoro e di università ma nessuno riusciva a comprendere o risolvere il problema. Dopo vari giorni di tentativi, discussioni e ricerche ho scoperto che a quanto pare a CMake non piaceva l'impostazione che specificava il linguaggio del progetto di tale librerie a C/C\texttt{++} essendo i file di libreria .c. Togliendo completamente quell'istruzione tutto ha ripreso a compilare correttamente.
