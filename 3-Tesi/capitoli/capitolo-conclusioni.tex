...
\begin{itemize}
	 ...
	 \item \underline{\textit{F02}} (analisi unit-testing su GUI-Qt): soddisfatto. Sono stati sviluppati alcuni semplici \emph{unit-test} utilizzando il \emph{framework} di \emph{test} fornito da Qt. Come accennato nella sezione \nameref{sec:test-begin} (§\ref{sec:test-begin}) non è stato possibile fare un vero e proprio test sul \emph{render} del volume, ma il \emph{tutor} si è trovato d'accordo con questo risultato;
